  ...
  return (
    <main id="app-main">
      <noscript>
        ...
        >
          AnkiFlow requires JavaScript to run. Please enable JavaScript in your
          browser.
        </div>
      </noscript>
      ...
      <div className="app-container" id="appContainer" style={{ visibility: "hidden", position: "absolute" }}>
          ...
          <div className="sidebar-footer">
            ...
            <div className="daily-goal-widget" id="dailyGoalWidget">
              ...
              <div className="goal-info">
                <span className="goal-text" id="goalText">0 / 20 cards today</span>
                <span className="streak-badge" id="streakBadge">🔥 0</span>
              </div>
            </div>
        ...
        <div className="main-content">
            ...
            <div className="omnibar-container" id="omnibarContainer">
              ...
              <div className="omnibar-actions">
                <div className="md-toolbar">
                  <button className="md-btn" title="Bold (Ctrl+B)" data-md="**"><b>B</b></button>
                  <button className="md-btn" title="Italic (Ctrl+I)" data-md="*"><i>I</i></button>
                  <button className="md-btn" title="Code (Ctrl+`)" data-md="`">&lt;/&gt;</button>
                </div>
              ...
              <div className="deck-header">
                ...
                <div className="deck-actions-header">
                  <button className="action-btn secondary" id="btnFindReplace" title="Find & Replace">
                    <ion-icon name="search-outline"></ion-icon> <span className="btn-text">Find &amp; Replace</span>
                  </button>
                  <button className="action-btn secondary" id="btnImportCards">
                    <ion-icon name="cloud-upload-outline"></ion-icon> <span className="btn-text">Import</span>
                  </button>
                  <button className="action-btn secondary" id="btnExportDeck">
                    <ion-icon name="download-outline"></ion-icon> <span className="btn-text">Export</span>
                  </button>
                  <button className="action-btn primary" id="btnStudyDeck">
                    <ion-icon name="play-circle-outline"></ion-icon> <span className="btn-text">Study</span>
                  </button>
                </div>
                <div className="deck-stats">
                  <span className="stat-badge"><span id="countTotal">0</span> Items</span>
                  <span className="stat-badge warning hidden" id="countIssues">0 Issues</span>
                </div>
              </div>
            ...
            <div className="workspace study-workspace">
              ...
              <div className="study-view-container">
                ...
                <div id="sessionSummary" className="session-summary hidden">
                  ...
                  <p className="summary-subtitle" id="summarySubtitle">You reviewed 0 cards</p>
                  <div className="summary-grid">
                    <div className="summary-stat again">
                      <div className="summary-stat-value" id="summaryAgain">0</div>
                      <div className="summary-stat-label">Again</div>
                    </div>
                    <div className="summary-stat hard">
                      <div className="summary-stat-value" id="summaryHard">0</div>
                      <div className="summary-stat-label">Hard</div>
                    </div>
                    <div className="summary-stat good">
                      <div className="summary-stat-value" id="summaryGood">0</div>
                      <div className="summary-stat-label">Good</div>
                    </div>
                    <div className="summary-stat easy">
                      <div className="summary-stat-value" id="summaryEasy">0</div>
                  ...
                  <div className="summary-accuracy">
                    <div className="accuracy-ring" id="accuracyRing">
                      <svg viewBox="0 0 36 36">
                        ...
                        <path className="ring-fg" id="accuracyPath" strokeDasharray="0, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                      </svg>
                      <span className="accuracy-text" id="accuracyText">0%</span>
                    </div>
                    <span className="accuracy-label">Accuracy</span>
                  </div>
                  <div className="summary-actions">
                    <button className="action-btn secondary" id="btnBackToLibrary">Back to Library</button>
                    <button className="action-btn primary" id="btnStudyAgain">Study Again</button>
                  </div>
                </div>
                ...
                <div id="studyInterface" className="study-interface hidden">
                  ...
                  <div className="study-controls">
                    <button className="action-btn primary large" id="btnStudyFlip">Show Answer (Space)</button>
                    <div className="study-rating-buttons hidden">
                      <button className="rating-btn rating-again" id="btnAgain">
                        <ion-icon name="close-circle"></ion-icon> Again <kbd className="rating-kbd">1</kbd>
                      </button>
                      <button className="rating-btn rating-hard" id="btnHard">
                        <ion-icon name="sad-outline"></ion-icon> Hard <kbd className="rating-kbd">2</kbd>
                      </button>
                      <button className="rating-btn rating-good" id="btnGood">
                        <ion-icon name="checkmark-circle"></ion-icon> Good <kbd className="rating-kbd">3</kbd>
                      </button>
                      <button className="rating-btn rating-easy" id="btnEasy">
                        <ion-icon name="happy-outline"></ion-icon> Easy <kbd className="rating-kbd">4</kbd>
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div id="view-statistics" className="view-container hidden">
            <div className="workspace">
              <div className="deck-header"><h1>Statistics</h1></div>
              <div className="view-content">
                <div className="stats-grid">
                  <div className="overview-card">
                    <div className="overview-label">Total Cards</div>
                    <div className="overview-value" id="tabStatTotalCards">0</div>
                  </div>
                  <div className="overview-card">
                    <div className="overview-label">Total Decks</div>
                    <div className="overview-value" id="tabStatTotalDecks">0</div>
                  </div>
                </div>
          ...
          <div id="view-settings" className="view-container hidden">
            <div className="workspace">
              <div className="deck-header"><h1>Settings</h1></div>
              <div className="view-content">
                <div className="settings-container">
                  ...
                  <h3 className="section-title" style={{ marginTop: "24px" }}>Study</h3>
                  <div className="settings-card">
                    <div className="settings-row">
                      ...
                      <input type="number" className="settings-input" id="settingNewCards" min={1} max={100} defaultValue={20} />
                    </div>
                    <div className="settings-row">
                      <div className="settings-row-info">
                      ...
                      <input type="number" className="settings-input" id="settingMaxReviews" min={10} max={500} defaultValue={100} />
                    </div>
                    <div className="settings-row">
                      <div className="settings-row-info">
                      ...
                      <input type="number" className="settings-input" id="settingDailyGoal" min={1} max={200} defaultValue={20} />
                    </div>
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <span className="settings-label">Reverse mode</span>
                        <span className="settings-sublabel">Show definition first, guess the term</span>
                      </div>
                  ...
                  <h3 className="section-title" style={{ marginTop: "24px" }}>Spaced Repetition</h3>
                  <div className="settings-card">
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <span className="settings-label">Interval modifier</span>
                        <span className="settings-sublabel">Multiply all intervals by this value (100% = default)</span>
                      </div>
                      <div className="settings-range-group">
                        <input type="range" className="settings-range" id="settingIntervalMod" min={50} max={200} defaultValue={100} />
                        <span className="settings-range-value" id="intervalModValue">100%</span>
                      </div>
                    </div>
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <span className="settings-label">Learning steps (minutes)</span>
                        <span className="settings-sublabel">Steps for new cards (comma separated)</span>
                      </div>
                      <input type="text" className="settings-input wide" id="settingLearningSteps" defaultValue="1, 10" />
                    </div>
                  </div>

                  <h3 className="section-title" style={{ marginTop: "24px" }}>Display</h3>
                  <div className="settings-card">
                    <div className="settings-row">
                      <div className="settings-row-info">
                      ...
                      <div className="settings-range-group">
                        <input type="range" className="settings-range" id="settingFontSize" min={16} max={48} defaultValue={32} />
                        <span className="settings-range-value" id="fontSizeValue">32px</span>
                      </div>
                    </div>
                    <div className="settings-row">
                      <div className="settings-row-info">
                        <span className="settings-label">Sound effects</span>
                        <span className="settings-sublabel">Play sounds on card flip and rating</span>
                      </div>
                      <label className="toggle-switch">
                  ...
                  <h3 className="section-title" style={{ marginTop: "24px" }}>Data</h3>
                  <div className="settings-card">
                    <div className="settings-row">
                      <div className="settings-row-info">
                    ...
                    <div className="settings-row">
                      <div className="settings-row-info">
                        ...
                        <span className="settings-sublabel">Delete all decks and cards permanently</span>
                      </div>
          ...
          <div id="bulkActionBar" className="bulk-bar hidden">
            <div className="bulk-info"><span id="bulkCount">0</span> selected</div>
      ...
      {/* TOAST */}
      <div id="toast" className="toast hidden" role="alert" aria-live="polite">Action Successful</div>
      ...
      <div id="exportModal" className="modal-overlay hidden" role="dialog" aria-modal="true">
        <div className="modal-glass">
          ...
          <div className="form-group">
            ...
            <div className="radio-group">
              <label className="radio-option">
                <input type="radio" name="exportFormat" value="apkg" defaultChecked /> <span>Anki Package (.apkg)</span>
              </label>
              <label className="radio-option">
          ...
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnCancelExport">Cancel</button>
            <button className="action-btn secondary" id="btnPreviewExport">Preview</button>
            <button className="action-btn primary" id="btnConfirmExport">Download .apkg</button>
          </div>
        ...
        <div className="modal-glass" style={{ maxWidth: "700px" }}>
          ...
          <div className="preview-stats">
            <div className="stat-item">
              <ion-icon name="library-outline"></ion-icon>
              <div><strong id="previewTotalCards">0</strong><span>Total Cards</span></div>
            </div>
            <div className="stat-item">
              <ion-icon name="checkmark-circle-outline"></ion-icon>
              <div><strong id="previewValidCards">0</strong><span>Valid Cards</span></div>
            </div>
            <div className="stat-item warning">
              <ion-icon name="alert-circle-outline"></ion-icon>
              <div><strong id="previewIssues">0</strong><span>Issues</span></div>
            </div>
          </div>
          <h3 style={{ marginTop: "24px", marginBottom: "12px", fontSize: "16px" }}>Sample Cards (First 5)</h3>
          <div className="preview-cards" id="previewCardsList"></div>
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnClosePreview">Close</button>
            <button className="action-btn primary" id="btnConfirmFromPreview">Looks Good - Export</button>
          </div>
        </div>
      </div>
        ...
        <div className="modal-glass">
          ...
          <div className="shortcuts-table">
            <div className="shortcuts-section">
              <h3>Navigation</h3>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>F1</kbd></span><span className="shortcut-desc">Open command palette</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Esc</kbd></span><span className="shortcut-desc">Close modals / Clear command palette</span></div>
            </div>
            <div className="shortcuts-section">
              <h3>Editing</h3>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Enter</kbd></span><span className="shortcut-desc">Add card from omnibar</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>Z</kbd></span><span className="shortcut-desc">Undo last action</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>Y</kbd></span><span className="shortcut-desc">Redo action</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>F</kbd></span><span className="shortcut-desc">Focus search</span></div>
            </div>
            <div className="shortcuts-section">
              <h3>Study Mode</h3>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Space</kbd></span><span className="shortcut-desc">Show answer / flip card</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>1</kbd></span><span className="shortcut-desc">Rate: Again</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>2</kbd></span><span className="shortcut-desc">Rate: Hard</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>3</kbd></span><span className="shortcut-desc">Rate: Good</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>4</kbd></span><span className="shortcut-desc">Rate: Easy</span></div>
            </div>
            <div className="shortcuts-section">
              <h3>Views</h3>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>1</kbd></span><span className="shortcut-desc">Library view</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>2</kbd></span><span className="shortcut-desc">Study view</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>3</kbd></span><span className="shortcut-desc">Statistics view</span></div>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>4</kbd></span><span className="shortcut-desc">Settings view</span></div>
            </div>
            <div className="shortcuts-section">
              <h3>Help</h3>
              <div className="shortcut-row"><span className="shortcut-keys"><kbd>Ctrl</kbd> + <kbd>/</kbd></span><span className="shortcut-desc">Show this help panel</span></div>
            </div>
          </div>
          <div className="modal-actions">
            <button className="action-btn primary" id="btnCloseShortcuts">Close</button>
          </div>
        </div>
      </div>
      ...
      <div id="colorPickerModal" className="modal-overlay hidden">
        <div className="modal-glass">
          ...
          <div className="color-grid">
            {["#6366F1","#8B5CF6","#EC4899","#F43F5E","#F97316","#F59E0B","#84CC16","#10B981","#14B8A6","#06B6D4","#3B82F6","#6366F1"].map((c, i) => (
              <button key={i} className="color-option" data-color={c} style={{ background: c }}></button>
            ))}
          </div>
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnCancelColor">Cancel</button>
          </div>
        </div>
      </div>

      {/* GENERIC CUSTOM MODAL */}
      <div id="customModal" className="modal-overlay hidden" role="dialog" aria-modal="true" aria-labelledby="customModalTitle">
        <div className="modal-glass">
          ...
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnModalCancel">Cancel</button>
            <button className="action-btn primary" id="btnModalConfirm">Confirm</button>
          </div>
        </div>
      </div>
      ...
      <div id="importPreviewModal" className="modal hidden">
        <div className="preview-modal-content">
          ...
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnCancelImport">Cancel</button>
            <button className="action-btn primary" id="btnConfirmImport">Import Cards</button>
          </div>
        </div>
      </div>
      ...
      <div id="findReplaceModal" className="modal-overlay hidden" role="dialog" aria-modal="true">
        <div className="modal-glass" style={{ maxWidth: "500px" }}>
          ...
          <div className="form-group" style={{ display: "flex", gap: "16px", flexWrap: "wrap" }}>
            ...
            <select id="findField" style={{ padding: "6px 10px", borderRadius: "6px", background: "var(--bg-surface)", color: "var(--text-primary)", border: "1px solid var(--border-default)" }}>
          ...
          <div className="modal-actions">
            <button className="action-btn secondary" id="btnCancelFindReplace">Cancel</button>
            <button className="action-btn primary" id="btnExecuteFindReplace">Replace All</button>
          </div>
        </div>
      </div>
